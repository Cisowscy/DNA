...
export class DNArootComponent {
  title = 'DNA - Genos Ethnos Logos [https://cisowscy.github.io/DNA/]';
navItems = [
 {name: 'GenMatch', route: 'autocomplete'},
 {name: 'DNA', route: 'button'}
];
...
constructor(private _element: ElementRef) {
 ...
 toggleFullscreen() {
    let elem = this._element.nativeElement.querySelector('.DNA-root-okno');
